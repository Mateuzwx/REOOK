...
class MaterialTheme {
  ...
  static MaterialScheme lightScheme() {
    return const MaterialScheme(
      ...
      secondaryFixed: Color(0xffffdf9a),
      onSecondaryFixed: Color(0xff251a00),
      secondaryFixedDim: Color(0xffe7c26c),
      onSecondaryFixedVariant: Color(0xff5a4300),
  ...
  static MaterialScheme lightMediumContrastScheme() {
    return const MaterialScheme(
      ...
      secondary: Color.fromARGB(255, 224, 249, 255),
      onSecondary: Color(0xffffffff),
      secondaryContainer: Color(0xff8f7023),
      ...
      primaryFixedDim: Color(0xff126381),
      onPrimaryFixedVariant: Color(0xffffffff),
      secondaryFixed: Color(0xff8f7023),
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff745808),
  ...
  static MaterialScheme lightHighContrastScheme() {
    return const MaterialScheme(
      ...
      onPrimaryFixedVariant: Color(0xffffffff),
      secondaryFixed: Color(0xff554000),
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff3a2a00),
      onSecondaryFixedVariant: Color(0xffffffff),
  ...
  static MaterialScheme darkScheme() {
    return const MaterialScheme(
      ...
      secondary: Color.fromARGB(255, 249, 244, 234),
  ...
  static MaterialScheme darkMediumContrastScheme() {
    return const MaterialScheme(
      ...
      secondary: Color(0xffecc670),
      onSecondary: Color(0xff1f1500),
      secondaryContainer: Color(0xffad8c3d),
      onSecondaryContainer: Color(0xff000000),
      tertiary: Color(0xffccc6ee),
      onTertiary: Color(0xff161231),
  ...
  static MaterialScheme darkHighContrastScheme() {
    return const MaterialScheme(
      ...
      secondaryContainer: Color(0xffecc670),
      onSecondaryContainer: Color(0xff000000),
